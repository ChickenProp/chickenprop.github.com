...
Trying some other things that don't work:

<>
*Empty tags* don't work to disable markdown on a line.
</>

<p>
Also, I can't disable it on *multiple lines*,

with just *one set of tags*. The lines get joined.
</p>
