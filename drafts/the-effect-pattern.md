...
I have another hypothesis, which is: much of the reason is that although Elm functions are *pure* - in the sense of "given the same input, they return the same output" - they aren't necessarily *transparent* - in the sense of "you can look at the output and verify that it's correct". In fact, the Elm architecture is remarkably opaque.
